...
def gen_datacards():
    ...
    norm_type = bsvj.pull_arg('--norm-type', type=str, default='theta', choices=['free','theta','gauss','crtf']).norm_type
    ...
    bsvj.InputData(regions, **jsons, asimov=asimov).gen_datacard(nosyst=nosyst, gof_type=gof_type, norm_type=norm_type, winners=winners, brute=brute)
