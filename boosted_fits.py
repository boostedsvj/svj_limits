...
all_pdfs = {
    ...
    "ua2s": PdfInfo("ua2s", {
        2: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0})',
        },
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*0.5*(3*pow(@0/{0},2) - 1))',
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*0.5*(3*pow(@0/{0},2) - 1) + @4*0.5*(5*pow(@0/{0},3) - 3*@0/{0}))',
        },
        5: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*0.5*(3*pow(@0/{0},2) - 1) + @4*0.5*(5*pow(@0/{0},3) - 3*@0/{0}) + @5*0.125*(35*pow(@0/{0},4) - 30*pow(@0/{0},2) + 3))',
        },
    }),
