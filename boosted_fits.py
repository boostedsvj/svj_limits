...
def known_pdfs():
    pdf_list = ["main", "alt", "ua2", "alt2", "alt3"]
    return pdf_list
...
all_pdfs = {
    ...
    "alt": PdfInfo("alt", {
        ...
        5: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@2*(1+@3*log(@0/{0})*(1+@4*log(@0/{0})*(1+@5*log(@0/{0})))))',
            "pars": {1: (-150., 150.), 2: (-100., 100.), 3: (-10., 10.), 4: (-10., 10.), 5: (-10., 10.)},
        },
    }),
    "alt2": PdfInfo("alt2", {
        2: {
        ...
        3: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@2+@3*log(@0/{0}))',
        },
        4: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@2+@3*log(@0/{0})+@4*pow(log(@0/{0}),2))',
            "pars": {1: (-75., 75.), 2: (-50,50), 3: (-25,25), 4: (-10,10)},
        },
        5: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@2+@3*log(@0/{0})+@4*pow(log(@0/{0}),2)+@5*pow(log(@0/{0}),3))',
            "pars": {1: (-100., 100.), 2: (-50,50), 3: (-25,25), 4: (-10,10), 5: (-10,10)},
            "mins": {1: (-100., 100.), 2: (-50,50), 3: (-25,25), 4: (-10,10), 5: (-10,10)},
            "maxs": {1: (-100., 100.), 2: (-50,50), 3: (-25,25), 4: (-10,10), 5: (-10,10)},
        },
    }),
    "alt3": PdfInfo("alt3", {
        2: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@1*@2)',
        },
        3: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@1*@2+@1*@3*log(@0/{0}))',
        },
        4: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@1*@2+@1*@3*log(@0/{0})+@1*@4*pow(log(@0/{0}),2))',
            "pars": {1: (-75., 75.), 2: (-50,50), 3: (-25,25), 4: (-10,10)},
        },
        5: {
            "expr": 'exp(@1*(@0/{0})) * pow(@0/{0},@1*@2+@1*@3*log(@0/{0})+@1*@4*pow(log(@0/{0}),2)+@1*@5*pow(log(@0/{0}),3))',
        },
    }),
    "ua2": PdfInfo("ua2", {
        2: {
