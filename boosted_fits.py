...
def known_pdfs():
    pdf_list = ["main", "alt", "ua2", "ua2m","ua2m2"]
    return pdf_list
...
all_pdfs = {
    ...
    "ua2m": PdfInfo("ua2m", {
        2: {
            "expr": 'pow(@0/{0}, (((0.009803469541040947*@2)+(-0.06532226986813526*@1))+0.3991999018785908)) * exp(@0/{0}*((((0.0034748611335126424*@2)+(0.18429078412021985*@1))+-12.110776272772043)))',
            "mins": {1: (-10., 10.), 2: (-10., 10.)},
        },
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0}))',
        },
    ...
    "ua2m2": PdfInfo("ua2m2", {
        2: {
            "expr": 'pow(@0/{0}, (((0.022874180327655758*@2)+(-0.037449565591496925*@1))+0.3991999270070883)) * exp(@0/{0}*((((0.004175237010206164*@2)+(0.20516873998728385*@1))+-12.110776262277966)))',
            "mins": {1: (-10., 10.), 2: (-10., 10.)},
        },
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0}))',
