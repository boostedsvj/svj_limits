...
all_pdfs = {
    ...
    "ua2d": PdfInfo("ua2d", {
        2: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*(@2))',
        },
        3: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*(@2+ (-2+0.1*@1)*(5+0.1*@3)*@0/{0}))',
            "mins": {1: (-50,50), 3: (-20, 20)},
        },
        4: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*(@2+ (-2+0.1*@1)*(5+0.1*@3)*@0/{0} + @4*pow(@0/{0},2)))',
            "mins": {1: (-50,50), 3: (-20, 20)},
        },
        5: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*(@2+ (-2+0.1*@1)*(5+0.1*@3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
            "mins": {1: (-50,50), 3: (-20, 20)},
        },
    }),
    "ua2d0": PdfInfo("ua2d0", {
        2: {
            "expr": 'pow(@0/{0}, (@1)) * exp(@0/{0}*(@1*@2))',
        },
        3: {
            "expr": 'pow(@0/{0}, (@1)) * exp(@0/{0}*(@1*@2+ (@1)*(@3)*@0/{0}))',
        },
        4: {
            "expr": 'pow(@0/{0}, (@1)) * exp(@0/{0}*(@1*@2+ (@1)*(@3)*@0/{0} + @4*pow(@0/{0},2)))',
        },
        5: {
            "expr": 'pow(@0/{0}, (@1)) * exp(@0/{0}*(@1*@2+ (@1)*(@3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
        },
    }),
    "ua2d2": PdfInfo("ua2d2", {
        2: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*((-2+0.1*@1)*(-2+0.1*@2)))',
        },
        3: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*((-2+0.1*@1)*(-2+0.1*@2) + (-2+0.1*@1)*(5+0.1*@3)*@0/{0}))',
            "mins": {1: (-50,50), 2: (-50,50), 3: (-30,30)},
        },
        4: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*((-2+0.1*@1)*(-2+0.1*@2) + (-2+0.1*@1)*(5+0.1*@3)*@0/{0} + @4*pow(@0/{0},2)))',
            "mins": {1: (-50,50), 2: (-50,50), 3: (-30,30)},
        },
        5: {
            "expr": 'pow(@0/{0}, (-2+0.1*@1)) * exp(@0/{0}*((-2+0.1*@1)*(-2+0.1*@2) + (-2+0.1*@1)*(5+0.1*@3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
            "mins": {1: (-50,50), 2: (-50,50), 3: (-30,30)},
        },
    }),
    "ua2r": PdfInfo("ua2r", {
        2: {
            "expr": 'pow(@0/{0}, -2+0.1*@1) * exp(@0/{0}*(4+0.1*@2))',
        },
        3: {
            "expr": 'pow(@0/{0}, -2+0.1*@1) * exp(@0/{0}*((4+0.1*@2) + (-11+0.1*@3)*@0/{0}))',
        },
        4: {
            "expr": 'pow(@0/{0}, -2+0.1*@1) * exp(@0/{0}*((4+0.1*@2) + (-11+0.1*@3)*@0/{0} + @4*pow(@0/{0},2)))',
        },
        5: {
            "expr": 'pow(@0/{0}, -2+0.1*@1) * exp(@0/{0}*((4+0.1*@2) + (-11+0.1*@3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
        },
    }),
