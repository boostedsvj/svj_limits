...
all_pdfs = {
    ...
    "ua2s": PdfInfo("ua2s", {
        ...
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*(2*pow(@0/{0},2) - 1))',
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*(2*pow(@0/{0},2) - 1) + @4*(4*pow(@0/{0},3) - 3*@0/{0}))',
        },
        5: {
            "expr": 'pow(@0/{0}, @1) * exp(@2*@0/{0} + @3*(2*pow(@0/{0},2) - 1) + @4*(4*pow(@0/{0},3) - 3*@0/{0}) + @5*(8*pow(@0/{0},4) - 8*pow(@0/{0},2) + 1))',
        },
    }),
