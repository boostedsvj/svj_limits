...
def known_pdfs():
    pdf_list = ["main", "alt", "ua2", "ua2d", "ua2r", "ua2r2", "ua2r3", "ua2s", "ua2s2", "ua2s3", "ua2s4", "ua2s5", "ua2s5i"]
    return pdf_list
...
all_pdfs = {
    ...
    "ua2d": PdfInfo("ua2d", {
        2: {
            "expr": 'pow(@0/{0}, @1) * exp(@1*@0/{0}*(1+@2))',
        },
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@1*@0/{0}*(1+@2)*(1+@3*@0/{0}))',
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@1*@0/{0}*(1+@2)*(1+@3*@0/{0})*(1+@4*@0/{0}))',
        },
        5: {
            "expr": 'pow(@0/{0}, @1) * exp(@1*@0/{0}*(1+@2)*(1+@3*@0/{0})*(1+@4*@0/{0})*(1+@5*@0/{0}))',
        },
    }),
    "ua2r": PdfInfo("ua2r", {
        2: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(-10.86 + -6.387*@1 + @2))',
        },
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + @3)*@0/{0}))',
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + @3)*@0/{0} + @4*pow(@0/{0},2)))',
        },
        5: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + @3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
        },
    }),
    "ua2r2": PdfInfo("ua2r2", {
        2: {
        ...
        3: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + -1.673*@2 + @3)*@0/{0}))',
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + -1.673*@2 + @3)*@0/{0} + @4*pow(@0/{0},2)))',
        },
        5: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*((-10.86 + -6.387*@1 + @2)+ (-0.0425 + 4.914*@1 + -1.673*@2 + @3)*@0/{0} + @4*pow(@0/{0},2) + @5*pow(@0/{0},3)))',
        },
    }),
    "ua2r3": PdfInfo("ua2r3", {
        2: {
        ...
        3: {
            "expr": 'pow(@0/{0}, (-0.114*@3 + 0.281*@2 + -0.637*@1 + -2.44)) * exp(@0/{0}*((-0.0225*@3 + -1.1*@2 + 4.6*@1 + 5.05) + (-0.00659*@3 + -1.11*@2 + -4.69*@1 + -12.3)*@0/{0}))',
    ...
    "ua2s": PdfInfo("ua2s", {
        ...
        3: {
            "expr": 'pow(@0/{0}, (0.00793*@3 + -0.034*@1 + 0.0472*@2 + -2.3)) * exp(@0/{0}*((0.00275*@3 + -0.0469*@1 + -0.119*@2 + 4.39) + (0.00219*@3 + -0.0218*@2 + 0.182*@1 + -11.3)*@0/{0}))',
            "mins": {1: (-20,20), 2: (-20,20), 3: (-50,50)},
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0} + @4*pow(@0/{0},2)))',
        },
    ...
    "ua2s2": PdfInfo("ua2s2", {
        ...
        3: {
            "expr": 'pow(@0/{0}, (-0.00572*@3 + 0.0215*@2 + -0.0429*@1 + -2.49)) * exp(@0/{0}*((-0.00172*@3 + -0.038*@2 + 0.297*@1 + 5.88)+ (-0.00112*@3 + -0.0513*@2 + -0.238*@1 + -12.5)*@0/{0}))',
            "mins": {1: (-75,75), 2: (-30,30), 3: (-30,30)},
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0} + @4*pow(@0/{0},2)))',
        },
    ...
    "ua2s3": PdfInfo("ua2s3", {
        ...
        3: {
            "expr": 'pow(@0/{0}, (-0.00529*@3 + 0.0189*@2 + -0.0296*@1 + -2.25)) * exp(@0/{0}*((-0.00152*@3 + -0.0365*@2 + 0.248*@1 + 4.24) + (-0.00101*@3 + -0.0439*@2 + -0.219*@1 + -11.3)*@0/{0}))',
            "mins": {1: (-20,20), 2: (-30,30), 3: (-50,50)},
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0} + @4*pow(@0/{0},2)))',
        },
    ...
    "ua2s4": PdfInfo("ua2s4", {
        ...
        3: {
            "expr": 'pow(@0/{0}, (-0.00648*@3 + 0.0278*@2 + -0.0531*@1 + -2.25)) * exp(@0/{0}*((-0.00211*@3 + -0.0348*@2 + 0.267*@1 + 4.24) + (-0.00148*@3 + -0.0724*@2 + -0.149*@1 + -11.3)*@0/{0}))',
            "mins": {1: (-20,20), 2: (-30,30), 3: (-50,50)},
        },
        4: {
            "expr": 'pow(@0/{0}, @1) * exp(@0/{0}*(@2+ @3*@0/{0} + @4*pow(@0/{0},2)))',
